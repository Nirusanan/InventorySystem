...
def association_rules_generation(trs_df):
    # get 4% frequent support items
    res = apriori(trs_df, min_support=0.02, use_colnames=True)

    rules = association_rules(res, metric="confidence", min_threshold=0.0002)
