                ...
                <div className='ProcurementBody'>
                    ...
                    <div style={{ backgroundColor: "white" }}>
                        <Line
                            ...
                            data={{
                                // labels: ['2021-Jul', '2021-Aug', '2021-Sep', '2021-Oct', '2021-Nov', '2021-Dec', '2022-Jan', '2022-Feb', '2022-Mar', '2022-Apr', '2022-May', '2022-Jun'],
                                labels: ['2021-Dec', '2022-Jan', '2022-Feb', '2022-Mar', '2022-Apr', '2022-May', '2022-Jun', '2022-Jul', '2022-Aug', '2022-Sep', '2022-Oct', '2022-Nov'],
                                datasets: [
                                    {
                                        label: 'Sold measure',
                                        data: series,
                                    ...
                                    },
                                    {
                                        label: 'Prediction',
                                        //data: [{x:'2016-12-25', y:20}, {x:'2016-12-26', y:10}]
                                        // data: [{ x: '2022-Jul', y: prediction[0] }, { x: '2022-Aug', y: prediction[1] }, { x: '2022-Sep', y: prediction[2] }],
                                        data: [{ x: '2022-Dec', y: prediction[0] }, { x: '2023-Jan', y: prediction[1] }, { x: '2023-Feb', y: prediction[2] }],
                                        fill: false,
                                        borderColor: 'rgb(255,0,0)',
                                        // xAxisID: 'x1',
                                        // tension: 0.1,
